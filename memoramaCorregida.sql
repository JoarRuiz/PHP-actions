-- Configuraciones iniciales (del primer archivo)
SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";
SET time_zone = "+00:00";

-- Configuraciones adicionales (del segundo archivo)
...
-- Estructura de la base de datos (del primer archivo)
CREATE DATABASE IF NOT EXISTS `memorama` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `memorama`;

-- Estructura de la tabla `materias` (del primer archivo)
...
-- Datos de la tabla `materias` (del segundo archivo)
...
-- Estructura de la tabla `parejas` (del primer archivo)
...
-- Datos de la tabla `parejas` (del segundo archivo)
...
-- Estructura de la tabla `usuario` (del primer archivo)
...
-- Datos de la tabla `usuario` (del segundo archivo)
...
-- Restaurar configuraciones originales (del segundo archivo)
/*!40101 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS */;
/*!40101 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS */;
/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE */;

-- Restaurar configuraciones originales (del primer archivo)
